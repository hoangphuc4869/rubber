...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Nông trại /</span> Chứng chỉ</h4>
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Thêm chứng chỉs</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('certificates.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="certificate_file" name="certificate_file" required>
                    </div>
                ...
                <tr>
                    ...
                    <td>
                         @if ($certificate->file_path)
                            <a href="/certificates_file/{{ $certificate->file_path }}" target="_blank"><button class="btn btn-info">Xem file</button></a>
                        @else
                            No file attached
                        @endif
                    </td>
                    <td>
                       <div class="custom d-flex gap-1">
                        ...
                        <form action="{{route('certificates.destroy', [$certificate->id])}}" method="POST" onsubmit="return confirmDelete();">
                            @csrf
                            @method('DELETE')
