    ...
    <table id="datalist" class="ui celled table" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{!! $item->trang_thai == "Chưa thanh toán" ? '<span class="text-danger">Chưa thanh toán</span>' :
                    ($item->trang_thai == "Hoàn tất" ? '<span class="text-success">Hoàn tất</span>' : '<span
                        class="text-warning">Một phần</span>') !!}</td>
