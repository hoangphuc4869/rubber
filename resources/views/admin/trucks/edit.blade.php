            ...
            <div class="card-body">
                ...
                <form action="{{ route('trucks.update', $truck->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="code" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ $truck->code }}" placeholder="BHCK-xx">
                        @error('code')
                ...
                <tr>
                    ...
                    <td>
                       <div class="custom d-flex gap-1">
                        ...
                        <form action="{{route('trucks.destroy', [$truck->id])}}" method="POST" onsubmit="return confirmDelete();">
                            @csrf
                            @method('DELETE')
